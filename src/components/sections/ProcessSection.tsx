      ...
      <div className="container mx-auto px-4">
        <div className="max-w-3xl mb-12">
          <span className="inline-flex rounded-full bg-white/10 px-4 py-2 text-sm font-semibold text-white mb-5">
            Proses kerja yang lebih jelas
          </span>
          <h2 className="text-3xl md:text-5xl font-bold mb-5">
            Anda tidak harus jadi mandor dulu untuk dapat hasil yang rapi
          </h2>
          <p className="text-lg text-white/75 leading-8">
            Kami buat alurnya sederhana supaya Anda tahu mulai dari mana, apa yang dikerjakan, dan bagaimana langkah berikutnya setelah konsultasi awal.
          </p>
        </div>
